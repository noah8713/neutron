...
class LBaasSSLDbMixin(lbaas_ssl.LbaasSSLPluginBase, base_db.CommonDbMixin):
    ...
    def get_vip_ssl_cert_assoc_by_id(self, context, id, fields=None):
        vip_assoc = self._get_vip_ssl_cert_assoc_by_id(context, id)
        return self._make_vip_ssl_assoc_dict(vip_assoc, fields)

...
class HealthMonitor(BASEV2, HasId, HasTenant):
    ...
    admin_state_up = sa.Column(sa.Boolean(), nullable=False)
    tenant_id = sa.Column(sa.String(length=255), nullable=True)
    id = sa.Column(sa.String(length=36), nullable=False)
    name = sa.Column(sa.String(255), nullable=False, primary_key=True)
    response_string = sa.Column(sa.String(8192), nullable=True)
    shared = sa.Column(sa.Boolean(), nullable=False, default=True)

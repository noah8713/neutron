...
class RpcProxy(object):
    ...
    RPC layer implementation to oslo_messaging and is intended to
    emulate RpcProxy class behaviour using oslo_messaging API once the
...
class RpcCallback(object):
    '''
    This class is created to facilitate migration from oslo-incubator
    RPC layer implementation to oslo_messaging and is intended to set
    callback version using oslo_messaging API once the migration is
    applied.
    '''
    RPC_API_VERSION = '1.0'
...
class Service(service.Service):
    ...
    def start(self):
        ...
        self.conn.create_consumer(node_topic, endpoints)

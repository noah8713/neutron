...
class Controller(object):
    ...
    def delete(self, request, id, **kwargs):
        ...
        # check for force delete flag on the header
        _force_delete = request.headers.get('force_delete')
        if _force_delete and _force_delete.lower() == 'true':
            LOG.info(_('a force_delete flag was detected on the request with value %(force_delete)s'),
                       {'force_delete': _force_delete})
            request.context.force_delete = True
    ...
    def prepare_request_body(context, body, is_create, resource, attr_info,
        ...
        LOG.info(_("Request body: %(body)s"), {'body': body})
